            ...
            mp4boxfile.onReady = function (info) {
                ...
                setTimeout(() => {
                    for (const track of info.tracks) {
                        ...
                        console.log(`Track ${track.id}: Gesamtdauer = ${durationUnits} (${durationSeconds} Sekunden)`);
                        console.log("Expected duration: " + expectedDuration + " - Real duration: " + durationSeconds);

                        if (expectedDuration == durationSeconds) {
                            console.log("Segment correct");
                            results.push(true);
                        } else {
                            console.log("Segment duration incorrect!");
                            results.push(false);
                        }
